...
export default function WorkflowsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'investigation' | 'remediation' | 'cicd'>('investigation');

  const tabs = [
    { id: 'investigation' as const, label: '1. Investigation', dot: 'bg-accent' },
    { id: 'remediation' as const, label: '2. Remediation', dot: 'bg-high' },
    { id: 'cicd' as const, label: '3. CI/CD', dot: 'bg-low' },
  ];
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-48px)] bg-background text-foreground font-sans">
      <section className="border-b border-border-hairline px-6 py-10">
      ...
      <section className="border-b border-border-hairline px-6 py-0">
        <div className="max-w-4xl mx-auto">
          <div className="flex gap-0 -mb-px">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 font-mono text-xs font-semibold tracking-wide border-b-2 transition-colors ${
                  activeTab === tab.id
        ...
        <div className="max-w-4xl mx-auto">
          {activeTab === 'investigation' && (
            ...
            >
              ...
              <Link
                href="/console"
                className="inline-block rounded bg-accent px-4 py-2 font-mono text-xs font-semibold text-[#10182B] transition-opacity hover:opacity-90"
              >
